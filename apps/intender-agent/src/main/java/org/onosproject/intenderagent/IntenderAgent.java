...
public class IntenderAgent {
    ...
    private IntenderInterface intenderInterface;

    @Activate
    public void activate() {
        appId = coreService.registerApplication("org.onosproject.intenderagent");
        ...
        intenderInterface = new IntenderInterface(this);
        intenderInterface.start();
